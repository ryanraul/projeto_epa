	...
	
{
	...
	$sqlEdit = "UPDATE projeto set nome_proj='$nome', integrantes='$integ', curso='$curso', professor_resp='$professor', escala='$escala', descricao_proj='$desc',materiais='$materiais', obs='$obs' where id=$id";
	$resultado = $mysql->sqleditproj($sqlEdit);
}
...
echo ' <script type = "text/javascript">
        ...
        <meta http-equiv="refresh" content="0; url=projetoslist_adm.php">';
